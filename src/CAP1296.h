/*
 *	This is the header file of the CAP1296 library.
 */



#ifndef __CAP1296_H__
#define __CAP1296_H__
...
public:
  // Constructor
  CAP1296(byte addr = DEFAULT_I2C_ADDR);
...
//-----BEGIN CONFIGURATION FUNCTIONS-----
  ...
  void setMTPPatternSpecificButtons(bool cs1_mtp, bool cs2_mtp, bool cs3_mtp, bool cs4_mtp, bool cs5_mtp, bool cs6_mtp);
...
//-----END CONFIGURATION FUNCTIONS-----
  ...
  byte readRegister(CAP1296_Register reg);
  void readRegisters(CAP1296_Register reg, byte *buffer, byte len);
  void writeRegister(CAP1296_Register reg, byte data);
  void writeRegisters(CAP1296_Register reg, byte *buffer, byte len);
