/*
 *	This file defines all the I2C registers of the CAP1296 capacitive touch snesor.
 */

#ifndef __CAP1296_registers_H__
#define __CAP1296_registers_H__


enum CAP1296_Register
{
    MAIN_CONTROL = 0x00,
    GENERAL_STATUS = 0x02,
